...
//         // // Update the document
//         const newData = { ...documentData, movieQty };
...
//               >
//                 <td className="py-2 text-lg w-[25%]">{cartItem.movieTitle}</td>
...
//         </table>
//         <tr className="mt-5">
//           <button onClick={updateCart} className={`${classes.btn}`}>
//             {loading ? <AuthLoader /> : "Update Cart"}
//           </button>
//         </tr>
//       </div>
...
//         <div className="mt-5">
//           <Link className={`${classes.btn}`} to={"/checkout"}>
//             {loading ? <AuthContext /> : "Proceed To Checkout"}
//           </Link>
//         </div>
//       </div>
//     </div>
